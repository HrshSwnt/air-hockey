...
export default function HUD() {
  ...
  return (
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10 px-6 py-3 border-4 border-cyan-400 rounded-2xl text-white text-lg font-semibold bg-black/40 shadow-[0_0_20px_rgba(0,255,255,0.6)] backdrop-blur-sm animate-fade-in flex flex-col items-center space-y-1 w-fit">
      <div>
